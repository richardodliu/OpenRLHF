...
second-moment analysis, \Cref{rem:rloo-variance}) with adaptive asymmetric normalization (preserving advantage sign while enforcing the
empirical constraints in \Cref{def:adaptive-norm}, \Cref{eq:alpha-beta}). The second component, REINFORCE Pro, introduces
