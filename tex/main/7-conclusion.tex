...
prefix-level trust-region masking (a TRM-style proxy) that preserves the causal structure of autoregressive generation. We showed that the
...
framework highlights that prefix masking acts as a sample-level proxy for per-position trust-region filtering: the KL chain rule yields an
