...
\begin{enumerate}
    ...
    \end{equation}
    Prefix IS masks position 1 and a contiguous block of subsequent positions whose length increases with $|\ell_1|$ and decreases with $\epsilon$ (see proof for the precise condition), while token-level IS masks only position 1.
