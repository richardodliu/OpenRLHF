...
Appendix~\ref{app:mask-variants} collects several compatible variants (Variants~I--IV) that modify the prefix gate while retaining the same
...
\begin{proof}
By \Cref{def:prefix-trm-proxy}, $M_t^{\mathrm{pre}} = 1$ implies $\rhoprefix{t}\in[1-\epslow,1+\epshigh]$. Taking logarithms yields
