...
\]
Substituting into \eqref{eq:alpha-beta} yields
\[
\alpha
=
...
\begin{remark}[Sequence-Level IS Loses Positional Information: Standard limitation]
...
\begin{remark}[KL chain rule for the cumulative log-ratio: Standard identity]
\label{lem:cumsum-kl}
