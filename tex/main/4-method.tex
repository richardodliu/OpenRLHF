...
\begin{align}
    \frac{1}{N_{\mathrm{nz}}}\sum_{(i,t)\in\mathcal{P}\cup\mathcal{N}}\hat{A}_{i,t} &= 0,
    \label{eq:adaptive-mean}
    \\
    \frac{1}{N_{\mathrm{nz}}}\sum_{(i,t)\in\mathcal{P}\cup\mathcal{N}}\hat{A}_{i,t}^2 &= 1.
...
\begin{equation}
    \alpha S^+ = \beta S^-,
    \qquad
    \alpha^2 Q^+ + \beta^2 Q^- = N_{\mathrm{nz}}.
\end{equation}
\end{definition}
...
$\alpha^2 Q^+ + \beta^2 Q^- = N_{\mathrm{nz}}$ is:
\begin{equation}
    \alpha = \sqrt{\frac{N_{\mathrm{nz}}}{Q^+ + \left(\frac{S^+}{S^-}\right)^{\!2} Q^-}},
    \qquad
...
$\alpha^2 Q^+ + \beta^2 Q^- = N_{\mathrm{nz}}$ yields
\begin{align}
    \alpha^2 Q^+ + \beta^2 Q^-
    &= N_{\mathrm{nz}},
    \\
    ...
    \\
    \alpha^2
    &= \frac{N_{\mathrm{nz}}}{Q^+ + \left(\frac{S^+}{S^-}\right)^{2} Q^-}.
\end{align}
The denominator is strictly positive because $Q^+>0$, $Q^->0$, and $N_{\mathrm{nz}}>0$ under the same assumption. Taking the positive
square root gives the stated $\alpha>0$, and then \eqref{eq:beta-from-mean} yields the stated $\beta$.
