...
\begin{remark}[Token-Level IS Ignores Causal Structure (standard limitation)]
...
\begin{remark}[Sequence-Level IS Loses Positional Information (standard)]
...
\begin{remark}[KL chain rule for the cumulative log-ratio (standard)]
\label{lem:cumsum-kl}
