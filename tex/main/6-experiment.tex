...
\textbf{IS masking.} We compare token-level masking (ICEPOP), sequence-level masking (GSPO-style, based on $\ISseq$), and prefix-level
...
\midrule
Early ($r_1{=}10$; else $0$) & $1$ ($[1,1]$) & $0$ (---) & $6$ ($[1,6]$) \\
Late ($r_{24}{=}50$; else $0$) & $1$ ($[24,24]$) & $0$ (---) & $8$ ($[24,31]$) \\
Drift ($r_t{=}2,\ \forall t$) & $32$ ($[1,32]$) & $32$ ($[1,32]$) & $32$ ($[1,32]$) \\
\bottomrule
\end{tabular}
\end{table}
