...
\begin{tabular}{llll}
\toprule
\textbf{Method} & \textbf{IS Statistic} & \textbf{Gate / Truncation} & \textbf{Granularity} \\
\midrule
...
\begin{remark}[Context Shift Propagation (standard)]
\label{lem:coupling}
...
\par
\noindent This propagation property is standard in autoregressive generation; see, e.g., \citet{li2025trm}.
\end{remark}
