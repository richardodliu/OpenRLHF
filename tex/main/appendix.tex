...
\subsection{Leave-One-Out Baseline Properties: Summary}
...
\begin{remark}[On setting $\gamma = 1.0$ for sparse terminal rewards: Standard choice]
...
\subsection{Proof of Theorem~\ref{thm:prefix-tighter}}
