...
\begin{remark}[On setting $\gamma = 1.0$ for sparse terminal rewards (standard)]
...
\begin{enumerate}
    ...
    $\left(\frac{\sum_{(i,t)\in\mathcal{P}} A_{i,t}}{-\sum_{(i,t)\in\mathcal{N}} A_{i,t}}\right)^{\!2}
    \sum_{(i,t)\in\mathcal{N}} A_{i,t}^2$ is clamped to $10^8$ before computing $\alpha$.
