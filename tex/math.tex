...
%
% For backward compatibility with earlier drafts, we keep the legacy \IS* macros
% as aliases that render to the corresponding \rho-based symbols.
%==============================================================================
\newcommand{\rhoseq}{\rho_{\mathrm{seq}}}
\newcommand{\rhoprefix}[1]{\rho_{\mathrm{prefix},#1}}

\newcommand{\IStoken}[1]{\rho_{#1}}
\newcommand{\ISseq}{\rhoseq}
\newcommand{\ISprefix}[1]{\rhoprefix{#1}}
