...
%------------------------------------------------------------------------------
% We use a unified naming scheme that makes the granularity explicit:
% - token-level:  \IStoken{t}
% - sequence-level geometric mean: \ISseq
% - prefix-level geometric mean up to position t: \ISprefix{t}
%==============================================================================
\newcommand{\IS}{\mathrm{IS}}
\newcommand{\IStoken}[1]{\IS_{\mathrm{token},#1}}
\newcommand{\ISseq}{\IS_{\mathrm{seq}}}
\newcommand{\ISprefix}[1]{\IS_{\mathrm{prefix},#1}}
