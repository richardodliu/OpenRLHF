...
\begin{abstract}
Critic-free reinforcement learning methods for Large Language Models---such as REINFORCE++, GRPO, and RLOO---eliminate the need for a
value network, saving significant GPU memory. However, they face two intertwined challenges: high-variance advantage estimation and
