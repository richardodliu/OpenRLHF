...
second component, REINFORCE Pro, introduces prefix-level trust-region masking (a TRM-style proxy) that preserves the causal structure of
...
practical, per-position proxy for trust-region style filtering. Together, the two components target the two factors in the surrogate
